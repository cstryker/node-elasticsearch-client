...
/* COLIN - I had to add this... */
ElasticSearchClient.prototype.update = function(indexName, typeName, documentId, data, options) {
    ...
    return this.createCall({data:JSON.stringify(data),path:path, method:'POST'}, this.clientOptions);
}
